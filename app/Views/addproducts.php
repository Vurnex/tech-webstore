            ...
            <div class="col-6">
                ...
                <?php if(isset($_SESSION['fail1'])):?>
                    <div class="alert alert-danger">
                        <strong>The product has already been added.</strong>
                    </div>
                <?php endif;?>

                <!-- Call the save method from the Register controller -->
                <form action="<?= base_url();?>/addproducts/save" method="post" class="items-menu">
                    
                    <label for="iteminput">Choose a product ready for distribution.
                    </label>
                    
                    <select name="iteminput" class="form-select">
